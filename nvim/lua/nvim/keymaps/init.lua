...
vim.api.nvim_set_keymap("n", "<leader>ee", "<cmd>NvimTreeToggle<CR>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<leader>er", "<cmd>NvimTreeRefresh<CR>", { noremap = true, silent = true })
